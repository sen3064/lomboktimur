...
import 'sf_calendar_model.dart';
export 'sf_calendar_model.dart';

import 'package:syncfusion_flutter_datepicker/datepicker.dart';

class SfCalendarWidget extends StatefulWidget {
  const SfCalendarWidget({Key? key}) : super(key: key);
...
class _SfCalendarWidgetState extends State<SfCalendarWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SfCalendarModel());
  }
