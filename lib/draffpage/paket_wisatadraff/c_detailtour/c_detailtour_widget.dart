...
import 'c_detailtour_model.dart';
export 'c_detailtour_model.dart';

class CDetailtourWidget extends StatefulWidget {
  const CDetailtourWidget({Key? key}) : super(key: key);

  @override
  _CDetailtourWidgetState createState() => _CDetailtourWidgetState();
}

class _CDetailtourWidgetState extends State<CDetailtourWidget> {
  late CDetailtourModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CDetailtourModel());
  }
                                      ...
                                      child: Padding(
                                        ...
                                        child: ClipRRect(
                                          borderRadius:
                                              BorderRadius.circular(0.0),
                                          child: Image.asset(
                                            'assets/images/Boat-at-Sea-Komodo-Sailing-Indonesia-Labuan-Bajo.jpg',
                                            width: 300.0,
                                            height: 200.0,
                                            fit: BoxFit.cover,
                                          ),
                                          ...
                                          Padding(
                                            ...
                                            child: ClipRRect(
                                              borderRadius:
                                                  BorderRadius.circular(0.0),
                                              child: Image.network(
                                                'https://cf.bstatic.com/xdata/images/hotel/max1280x900/279832072.jpg?k=55cda05543d9f7403c40f8d638f278affdbb24a8458321026f766799e0964ab8&o=&hp=1',
                                                width: 300.0,
                                                height: 200.0,
                                                fit: BoxFit.cover,
                                              ),
                                                            ...
                                                            padding:
                                                                EdgeInsetsDirectional
                                                                    .fromSTEB(
                                                                        ...
                                                                        4.0),
                                                            child: Text(
                                                              'A product designer is a creative professional who is responsible',
