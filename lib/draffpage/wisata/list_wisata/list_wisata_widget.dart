...
import 'list_wisata_model.dart';
export 'list_wisata_model.dart';

class ListWisataWidget extends StatefulWidget {
  const ListWisataWidget({Key? key}) : super(key: key);

  @override
  _ListWisataWidgetState createState() => _ListWisataWidgetState();
}

class _ListWisataWidgetState extends State<ListWisataWidget> {
  late ListWisataModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListWisataModel());
  }
