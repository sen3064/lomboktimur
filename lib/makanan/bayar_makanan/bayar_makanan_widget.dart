...
import 'bayar_makanan_model.dart';
export 'bayar_makanan_model.dart';
import '/flutter_flow/flutter_flow_timer.dart';
import 'package:stop_watch_timer/stop_watch_timer.dart';

class BayarMakananWidget extends StatefulWidget {
  const BayarMakananWidget(
      {Key? key, required this.bookingCode, required this.items})
      : super(key: key);
  final String bookingCode;
  final Map<String, dynamic> items;
  @override
  _BayarMakananWidgetState createState() => _BayarMakananWidgetState();
}

class _BayarMakananWidgetState extends State<BayarMakananWidget> {
  late BayarMakananModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BayarMakananModel());
    // On page load action.
