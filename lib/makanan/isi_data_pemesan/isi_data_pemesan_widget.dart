...
import 'isi_data_pemesan_model.dart';
export 'isi_data_pemesan_model.dart';

class IsiDataPemesanWidget extends StatefulWidget {
  const IsiDataPemesanWidget({Key? key, required this.items}) : super(key: key);
  final Map<String, dynamic> items;

  @override
  _IsiDataPemesanWidgetState createState() => _IsiDataPemesanWidgetState();
}

class _IsiDataPemesanWidgetState extends State<IsiDataPemesanWidget> {
  late IsiDataPemesanModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => IsiDataPemesanModel());
            ...
            children: [
              ...
              if (FFAppState().accessToken != null &&
                ...
                Container(
                  ...
                  child: Padding(
                    padding: EdgeInsetsDirectional.fromSTEB(25, 20, 25, 50),
                    child: Column(
                      mainAxisSize: MainAxisSize.max,
                      children: [
                        Padding(
