...
import 'ubah_data_booking_backup_model.dart';
export 'ubah_data_booking_backup_model.dart';

class UbahDataBookingBackupWidget extends StatefulWidget {
  const UbahDataBookingBackupWidget({
    Key? key,
  ...
  @override
  _UbahDataBookingBackupWidgetState createState() =>
      _UbahDataBookingBackupWidgetState();
}

class _UbahDataBookingBackupWidgetState
    extends State<UbahDataBookingBackupWidget> {
  late UbahDataBookingBackupModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UbahDataBookingBackupModel());
                              ...
                              InkWell(
                                ...
                                onTap: () async {
                                  await Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => SfCalendarWidget(),
                                    ),
                                  );
                                },
                                child: Text(
                  ...
                  onPressed: () async {
                    if (FFAppState().location != null &&
                      ...
                      if (widget.startDate != null && widget.startDate != '') {
                        if (FFAppState().endDate != null) {
                          if (FFAppState().rooms != null &&
                              FFAppState().rooms != '') {
                            if (FFAppState().guests != null &&
                                FFAppState().guests != '') {
                              await Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) =>
                                      ListPenginapanSearchWidget(
