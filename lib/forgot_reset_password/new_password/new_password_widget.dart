                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      FFButtonWidget(
                        onPressed: () async {
                          _model.apiResult0e6789 =
                              await UserGroup.userResetPasswordCall.call(
                            email: _model.mailController.text,
                            password: _model.passwordController1!.text,
                            confirm_password: _model.passwordController2!.text,
                          );
                          print(_model.apiResult0e6789!.jsonBody);
                          if ((_model.apiResult0e6789?.succeeded ?? true)) {
                            setState(() {});
                            Get.defaultDialog(
                              title: "Sukses",
                              middleText: "Password berhasil di ganti",
                              onConfirm: () => Get.to(() => LoginPageWidget()),
                            );
                          } else {
