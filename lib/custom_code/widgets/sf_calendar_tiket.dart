...
class SfCalendarTiket extends StatefulWidget {
  const SfCalendarTiket({
    Key? key,
    this.width,
    this.height,
  }) : super(key: key);
  ...
  @override
  _SfCalendarTiketState createState() => _SfCalendarTiketState();
}

class _SfCalendarTiketState extends State<SfCalendarTiket> {
  DateTime? minDate;
