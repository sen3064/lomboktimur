...
import '../../components/add_new_addess.dart';
...
import 'pesan_kendaraan_mobil_model.dart';
export 'pesan_kendaraan_mobil_model.dart';

class PesanKendaraanMobilWidget extends StatefulWidget {
  const PesanKendaraanMobilWidget({
    Key? key,
    this.rentData,
  }) : super(key: key);
  ...
  @override
  _PesanKendaraanMobilWidgetState createState() =>
      _PesanKendaraanMobilWidgetState();
}

class _PesanKendaraanMobilWidgetState extends State<PesanKendaraanMobilWidget> {
  late PesanKendaraanMobilModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PesanKendaraanMobilModel());
  ...
  Widget build(BuildContext context) {
    ...
    Duration duration =
        FFAppState().endDate!.difference(FFAppState().startDate!);
    int days = duration.inDays;
    print(days);
    // print(widget.rentData['prices']);
                                          ...
                                          children: [
                                            Expanded(
                                              child: SwitchListTile.adaptive(
                                                ...
                                                subtitle: Text(
                                                  'Tidak punya supir? pesan dengan Supir',
                                          ...
                                          FFButtonWidget(
                                            onPressed: () async {
                                              addr = await Get.to(
                                                  () => const AddNewAddress(),
                                                  arguments: {
                                                    'latitude': gpsController
                                                        .latitude.value,
                                                    'longitude': gpsController
                                                        .longitude.value
                                                  });
                                              print(addr);
                                              setState(() {
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        await Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => ListPesananTransportasiWidget(
                              driver: _model.switchListTileValue,
                              rentData: widget.rentData,
                              day: days,
                            ),
                          ),
