...
import 'list_kendaraan_mobil_model.dart';
export 'list_kendaraan_mobil_model.dart';

class ListKendaraanMobilWidget extends StatefulWidget {
  const ListKendaraanMobilWidget({Key? key}) : super(key: key);

  @override
  _ListKendaraanMobilWidgetState createState() =>
      _ListKendaraanMobilWidgetState();
}

class _ListKendaraanMobilWidgetState extends State<ListKendaraanMobilWidget> {
  late ListKendaraanMobilModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListKendaraanMobilModel());
  }
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Switch.adaptive(
                        ...
                        inactiveTrackColor: Color(0x7FD9D9D9),
                        inactiveThumbColor:
